...
public class SuperFastFigure extends Figure{
    ...
    public static String path = "src"+File.separator+"main"+File.separator+"resources"+File.separator+"application"+File.separator+"SuperFastFigure.png";
    public static final File file = new File(path);
    public final Image image = new Image(file.toURI().toString());

    public SuperFastFigure(Colors color)
    {
        figureColor=color;
